...
| -------------- | -------------------------------------------------------------- | --------------------------------------- |
| `root`         | <pre>= prop<br/>\| '[' s '^'? s '-'? s seq* [\\$ \\-]? s ']' <br/>\| var</pre> | \\p{x=y},<br/>[abc],<br/>$myset                     |
...
* \$ is equivalent to \uFFFF when appearing at the very end of a set with or without trailing whitespace (**[a-z\$]**, **[a-z\$ ]**), and used as starting indicator for a variable reference elsewhere (**[\$my_set]**)
