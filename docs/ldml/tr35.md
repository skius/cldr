...
Note that some syntax characters only have a special meaning in a certain context. In particular, only \\, \}, and whitespace have a special meaning inside strings, and:
